...
5. Use the `post-implementation-retrospective` skill before finalizing commits: review changed files, verification, and whether skills, rules, docs, hooks, templates, or memory notes should be proposed or updated for future sessions.
